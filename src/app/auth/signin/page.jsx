...
//   //     //   "http://localhost:8000/api/auth/signin", // Update the URL as per your backend route
//   //     //   { email, password },
...
//   //   } catch (err) {
//   //     // if (err.response !==200 || err.response !==201 ) {
...
//       // Destructure token and rest from the response
//       const { token, rest } = res.data;
                            
//       // Save token to localStorage
//       localStorage.setItem("access_token", token);
  
//       // Fetch role from rest object
...
//         router.push("/portfolio");
//       } else {
//         console.warn("Unknown role. Please contact support.");
//       }
//     } catch (err) {
//       console.error("Login error:", err.response?.data?.message || err.message);
//     }
...
//         <div className="flex gap-2 text-sm mt-5 flex justify-between items-center  ">
//             <span>Don't Have an account?</span>
//             <Link href="/auth/signup" className="text-blue-500">
//               Sign Up
//             </Link>
//             <Link href="/auth/resetPassword" className="text-blue-500">
//               Forget Password
//              </Link>
//              {/* <button
//           type="button"
...
const SignIn = () => {
  ...
  return (
    ...
    <>
      ...
      {/* <div className="flex justify-center h-[1000px] items-center bg-[#C88603]"> */}
        <div className="rounded-xl font-lora flex justify-center w-full border border-yellow-500 bg-[#D1D5DB] shadow-default dark:border-white dark:bg-[#6B7280]">
          <div className="flex flex-wrap items-center">
            <div className="hidden w-full xl:block xl:w-1/2">
              <div className="px-26 py-17.5 text-center">
                <Link className="mb-5.5 inline-block" href="/">
                ...
                <form>
                  <div className="mb-4">
                    ...
                    <div className="relative">
                      ...
                      <span className="absolute text-black dark:text-white right-4 top-4">
                        <svg
                          className="fill-current"
                          width="22"
                          height="22"
                  ...
                  <div className="mb-5">
                    <button
                      type="submit"
                      onClick={submit}
                      className="w-full cursor-pointer rounded-lg border border-yellow-400 bg-gradient-to-r from-[#F6F700] via-yellow-400 to-[#9C7509] p-4 text-black dark:text-white transition hover:bg-opacity-90"
                    >
                      Login
                    </button>
                  </div>
                  ...
                  <div className="mt-6 text-center flex justify-between text-black">
                    <p>
                      Don’t have any account?{" "}
                      <Link href="/auth/signup" className="text-yellow-500 underline">
                        Sign Up
                      </Link>
                    </p>
                  </div>
