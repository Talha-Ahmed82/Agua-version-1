...
//     setFormData({
//       ...formData,
//       image: file, // Update image field with selected file
//     });
//   };
//   const submitHandler = async (e) => {
//     e.preventDefault();    console.log("Form Data:", formData);
//     if (!formData.name || !formData.email || !formData.password || !formData.image || !formData.walletAddress) {
...
//       );
//       console.log("Response:", response.data);
//       router.push("/auth/signin"); // Redirect on successful signup
//     } catch (error) {
//       console.error("Error during signup:", error.response?.data || error.message);
//     }
//   };
...
//       <div className="rounded-xl border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark max-w-lg w-full">
//         <div className="p-8">
...
import AuthComp from "../../../components/authComp/authLayout"
import Image from "next/image";
...
const SignUp = () => {
  ...
  return (
    ...
    <AuthComp>
      <div className="rounded-xl font-lora border border-yellow-500 bg-[#D1D5DB] shadow-default dark:border-white dark:bg-[#6B7280]">
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="px-26 py-17.5 text-center">
              <Link className="mb-5.5 inline-block" href="/">
          ...
          <div className="w-full border-yellow-500 dark:border-white xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form onsubmit={submitHandler}>
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      required
                      placeholder="Enter your full name"
                      className="w-full rounded-lg border border-yellow-500 bg-white dark:bg-[#272727] py-4 pl-6 pr-10 text-black outline-none focus:border-yellow-400 focus-visible:shadow-none dark:border-white dark:text-white dark:focus:border-gray-300"
                    />
                    <span className="absolute right-4 top-4">
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full rounded-lg border border-yellow-500 bg-white dark:bg-[#272727] py-4 pl-6 pr-10 text-black outline-none focus:border-yellow-400 focus-visible:shadow-none dark:border-white dark:text-white dark:focus:border-gray-300"
                    />
                    <span className="absolute right-4 text-black dark:text-white top-4">
                      <svg
                        className="fill-current"
                        width="22"
                        height="22"
                ...
                <div className="mb-5">
                  <button
                    type="submit"
                    className="w-full rounded-lg bg-gradient-to-r from-[#F6F700] via-yellow-400 to-[#9C7509] py-4 text-black dark:text-white  transition hover:bg-opacity-90"
                  >
                    Create Account
                  </button>
                </div>
                ...
                <div className="mt-6 text-center text-black dark:text-white">
                  <p>
                    Already have an account?{" "}
                    <Link href="/auth/signin" className="text-yellow-500 underline">
                      Sign in
                    </Link>
                  </p>
                </div>
